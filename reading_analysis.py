...
Adler, of dubious and questionable memory.""".split())
    ...
    question1 = {'t': 0, 'q': "What words does Sherlock use to describe Irene Adler?", 'a': "He thinks that she \"eclipses\" and \"predominates\" all other women. In fact, he always refer to her as simply \"the woman\".", 'i': {4 : {'mode': 'text', 'a': '"eclipses"', 'data': {'loc': 23}, 'id': 1}, 6: {'mode': 'text', 'a': '"predominates"', 'data': {'loc': 25}, 'id': 2}}}

    question2 = {'t': 0, 'q': "What does this tell us about how Sherlock feels about her?", 'a': "Sherlock feels that Irene is special.", 'i': {5: {'mode': 'choose', 'id': 3, 'a': 'special', 'choices': ['special', 'intelligent', 'beautiful', 'crazy']}}}

    question3 = {'t': 0, 'q': "Complete your answer to the question. Do you think he cares much about other women?", 'a': 'Sherlock feels that Irene is special, and that she "eclipses" and "predominates" her sex. She is unique to him, and .', 'i': {16: {'mode': 'choose', 'a': 'unique', 'id': 4, 'choices': ['helpful', 'respectful', 'unique', 'indignant']}, 20 : {'mode': 'free', 'id': 5}}}

    question4 = {'t': 0, 'q': "When Watson writes that \"All emotions, and that one particularly, were abhorrent...\", which emotion is he referring to as \"that one\"?", 'a': 'Love', 'i': {0: {'mode': 'fill', 'a': 'Love', 'id': 6}}}
    ...
    question6 = {'t': 0, 'q': "Here is the answer we've constructed together:", 'm': 'summary', 'a': 'Sherlock feels that Irene is special, and that she "eclipses" and "predominates" her sex. She is unique to him, and . He is not interested in romantic feelings. The phrase "a gibe and a sneer" indicates . The words "abhorrent" and "intrusions" tell us .', 'i': {20: {'mode': 'filled', 'id': 9}, 36: {'mode': 'filled', 'id': 10}, 44: {'mode': 'filled', 'id': 11}}}

    question7 = {'t': 1, 'q': "What adjectives does Watson use to describe Sherlock's mind? Complete the statement below.", 'a': 'Watson describes Sherlock\'s mind as cold and precise, but also .', 'i': {5: {'mode': 'text', 'a': 'cold', 'id': 12}, 7: {'mode': 'text', 'a': 'precise,', 'id': 13}, 10: {'mode': 'text', 'a': 'balanced.', 'id': 14}}}
